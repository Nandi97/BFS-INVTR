			...
			<div className="grid gap-4 sm:grid-cols-2">
				<div className="space-y-1.5">
					...
					<p className="text-muted-foreground text-xs">
						Stock quantities will be applied to this location.
					</p>
				</div>
			</div>

			<div className="space-y-1.5">
				<Label htmlFor="qb-stock-csv">
					Paste QB Physical Inventory Worksheet CSV
				</Label>
				<p className="text-muted-foreground text-xs">
					Export from QB: Reports → Physical Inventory Worksheet →
					Export to Excel/CSV. Columns: <strong>Item Name</strong>,{' '}
					<strong>Qty On Hand</strong>, <strong>Reorder Point</strong>{' '}
					(optional).
				</p>
				<Textarea
					id="qb-stock-csv"
