	...
	return (
		<form onSubmit={handleSubmit(onSubmit)} className="max-w-md space-y-4">
			<div className="space-y-1.5">
				...
				<Input
					id="companyName"
					placeholder="Beauty First Salon"
			...
			<div className="space-y-1.5">
				...
				<Input
					id="defaultLocation"
					placeholder="BF Warehouse"
					{...register('defaultLocation')}
				/>
				<p className="text-muted-foreground text-xs">
					Used when no location is specified during sync.
				</p>
			...
			<div className="space-y-1.5">
				...
				<Textarea
					id="notes"
					rows={3}
					placeholder="Optional notes about this QB integration…"
					{...register('notes')}
				/>
			</div>
