  ...
  return (
    <div className="space-y-4">
        ...
        {file ? (
          <>
            ...
            <button
              ...
              className="absolute top-2 right-2 rounded-md p-1 text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
            >
          ...
          <>
            ...
            <div className="text-center">
              <p className="text-sm font-medium">
                {isDragActive ? "Drop it here" : "Drop your XLS file here"}
              </p>
              <p className="text-xs text-muted-foreground mt-0.5">
                or click to browse — <span className="font-mono">.xls</span> / <span className="font-mono">.xlsx</span>, max 16 MB
              </p>
            </div>
          </>
        )}
      ...
      <div className="flex items-end gap-3">
        ...
        <Button onClick={handleImport} disabled={busy || !file} className="mb-0.5">
          {isUploading ? (
