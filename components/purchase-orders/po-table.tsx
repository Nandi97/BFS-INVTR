  ...
  return (
    <div className="space-y-4">
            ...
            {isLoading ? (
              ...
              <TableRow>
                <TableCell colSpan={8} className="h-40 text-center">
                  <div className="flex flex-col items-center gap-2 text-muted-foreground">
                    ...
                    <span className="font-medium">No purchase orders</span>
                    <span className="text-xs">Create your first PO using the button above.</span>
                  </div>
                </TableCell>
              </TableRow>
            ) : (
              rows.map((po) => (
                ...
                >
                  ...
                  <TableCell className="font-medium text-sm">{po.supplier.name}</TableCell>
                  <TableCell className="text-sm text-muted-foreground">{po.location.name}</TableCell>
                  ...
                  <TableCell className="text-sm text-muted-foreground whitespace-nowrap">
                    {po.sentAt ? format(new Date(po.sentAt), "MMM d, yyyy") : "—"}
                  </TableCell>
                  <TableCell>
                    <Button
                      variant="ghost"
                      ...
                      onClick={(e) => { e.stopPropagation(); setOpenPoId(po.id); }}
                    >
                      View
                    </Button>
                  </TableCell>
      ...
      <div className="flex items-center justify-between">
        <p className="text-xs text-muted-foreground">{total} order{total !== 1 ? "s" : ""}</p>
        {totalPages > 1 && (
