						...
						<>
							<SheetHeader className="px-6 pt-6 pb-2">
								...
								<SheetDescription>
									...
									{po.sentAt &&
										` · Sent ${format(new Date(po.sentAt), 'MMM d, yyyy')}`}
									{po.receivedAt &&
										` · Received ${format(new Date(po.receivedAt), 'MMM d, yyyy')}`}
								</SheetDescription>
							</SheetHeader>
			...
			<AlertDialog open={cancelDialog} onOpenChange={setCancelDialog}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							This will mark the order as cancelled. Stock
							movements already recorded will not be reversed.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
