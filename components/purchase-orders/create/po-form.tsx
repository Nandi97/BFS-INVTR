...
export function POForm({ open, onOpenChange }: POFormProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      locationId: "",
      notes:      "",
      items:      [{ productId: "", quantity: 1, unitCost: undefined, notes: "" }],
    },
  });
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Delivery instructions, payment terms…" rows={2} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => append({ productId: "", quantity: 1, unitCost: undefined, notes: "" })}
                >
                    ...
                    <div className="flex items-start gap-2">
                      <div className="flex-1 space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <FormField
                            ...
                            render={({ field: f }) => (
                              <FormItem>
                                <FormLabel className="text-xs">Unit Cost <span className="text-muted-foreground">(opt.)</span></FormLabel>
                                <FormControl>
                                  <Input
                                    type="number"
                                    min={0}
                      ...
                      {fields.length > 1 && (
                        <Button
                          ...
                          variant="ghost"
                          size="icon"
                          className="size-7 mt-5 text-muted-foreground hover:text-destructive shrink-0"
