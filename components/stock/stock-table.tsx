  ...
  return (
    <Badge
      ...
      className={cn(
        ...
        s === "low" && "border-amber-500 text-amber-600 dark:text-amber-400",
        s === "ok" && "border-emerald-500 text-emerald-600 dark:text-emerald-400"
      )}
    >
...
export function StockTable({ defaultLocationId }: { defaultLocationId?: string }) {
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => setAdjustRow(row)}>
                          Adjust Stock
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => setThresholdRow(row)}>
                          Set Thresholds
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
