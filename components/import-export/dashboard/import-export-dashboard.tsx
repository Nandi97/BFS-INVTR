		...
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground mt-0.5 text-sm">
					Bulk import your product catalog, suppliers, and stock from
					...
					<Card>
						<CardContent className="pt-6">
							<div className="space-y-4">
								{locations.length > 0 && (
									<div className="rounded-lg border bg-amber-50 px-4 py-3 text-sm dark:bg-amber-950/20">
										...
										<div className="flex flex-wrap gap-2">
											{(
												...
												<code
													key={l.code}
													className="rounded bg-amber-100 px-1.5 py-0.5 text-xs dark:bg-amber-900/40"
												>
													{l.name}{' '}
				...
				<TabsContent value="export" className="mt-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Download snapshots of your current data as CSV
							</CardDescription>
						</CardHeader>
							...
							<div className="flex max-w-sm flex-col gap-3">
								<div className="flex items-center justify-between rounded-lg border p-4">
									<div>
										...
										<p className="text-muted-foreground text-xs">
											All active products with brand,
											barcode, supplier
										</p>
									</div>
									<Button
								...
								<div className="flex items-center justify-between rounded-lg border p-4">
									<div>
										...
										<p className="text-muted-foreground text-xs">
											Current qty on hand, reorder points,
											all locations
										</p>
									</div>
									<Button
								...
								<div className="text-muted-foreground pt-2 text-xs">
									For movement history and stock valuation
									reports, use the{' '}
									<a
										href="/reports"
