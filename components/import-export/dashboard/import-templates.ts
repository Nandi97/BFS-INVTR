...
export const PRODUCT_TEMPLATE: TemplateCol[] = [
	{
		header: 'name',
		example: 'Troiareuke Acidic pH Balancing Toner',
		required: true,
	},
...
export const STOCK_TEMPLATE: TemplateCol[] = [
	{
		header: 'identifier',
		example: '8809123456789',
		required: true,
		note: 'name, barcode, or SKU',
	},
	{
		header: 'location',
		example: 'BF Warehouse',
		required: true,
		note: 'location name or code',
	},
