...
export function ProductForm({ open, onClose, product }: ProductFormProps) {
	...
	async function onSubmit(values: ProductFormValues) {
		const payload = {
			...
			brandId:
				values.brandId === '__none__' ? null : values.brandId || null,
			categoryId:
				values.categoryId === '__none__'
					? null
				...
				>
					...
					<div className="space-y-2">
						...
						{imageUrl ? (
							...
							<div className="border-muted-foreground/25 bg-muted/30 flex h-28 w-full items-center justify-center rounded-lg border-2 border-dashed">
								<UploadButton
					...
					<div className="space-y-1">
						...
						<Input
							...
							placeholder="e.g. Nuskinn Body Wax"
						/>
						{errors.name && (
