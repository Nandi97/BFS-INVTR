		...
		<>
			<Table>
				...
				<TableBody>
					{products.map((p) => {
						const typeMeta =
							TYPE_LABEL[p.productType] ?? TYPE_LABEL.BOTH;
						return (
							<TableRow key={p.id}>
								<TableCell>
									<div>
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							<strong>{toArchive?.name}</strong> will be hidden
							from active inventory but its history will be
							preserved.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
