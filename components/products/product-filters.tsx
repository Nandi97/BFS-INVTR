...
export function ProductFiltersBar({ filters, onChange, onReset }: ProductFiltersProps) {
  ...
  const hasFilters = !!(filters.search || filters.brandId || filters.categoryId ||
    filters.productType || filters.isActive !== undefined);
  ...
  return (
    <div className="flex flex-wrap gap-2 items-center">
      ...
      <Select
        ...
        onValueChange={(v) => onChange({ brandId: v === "all" ? undefined : v, page: 1 })}
      >
      ...
      <Select
        ...
        onValueChange={(v) => onChange({ productType: v === "all" ? undefined : v, page: 1 })}
      >
      ...
      <Select
        ...
        onValueChange={(v) =>
          onChange({ isActive: v === "all" ? undefined : v === "active", page: 1 })
        }
      >
