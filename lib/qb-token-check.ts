...
export async function checkQbRefreshToken(): Promise<{ daysLeft: number | null; alerted: boolean }> {
  ...
  const appUrl = process.env.NEXT_PUBLIC_APP_URL ?? "https://bfs.kigtech.digital";
